...
**Live:**
- App: https://navx-nine.vercel.app
- API: https://navx-5ppw.onrender.com
...
binary and applied automatically on every boot — no manual migration step
against production. Frontend is a static Vite build on **Vercel**.
